    ...
    >
      ...
      <div className="pl-2">
        ...
        <div className="flex justify-between items-center">
          ...
          <motion.button
            whileTap={{ scale: 0.97 }}
            className="px-4 py-2 rounded-full bg-white text-primary border-2 border-primary text-sm font-bold shadow-button hover:bg-primary hover:text-white transition-colors"
            onClick={() => onClick(id)}
          >
            查看详情
          </motion.button>
